/**
 * Sign-up page with premium glassmorphism design
 *
 * @spec specs/003-todo-frontend/spec.md (FR-002, US1)
 */
...
export default function SignUpPage() {
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden bg-[#020617]">
      ...
      <div className="absolute bottom-20 left-10 w-80 h-80 bg-primary/20 rounded-full blur-3xl animate-float" style={{ animationDelay: '2s' }} />
      ...
      <div className="w-full max-w-md relative z-10 space-y-8 animate-fade-in">
        ...
        <div className="text-center space-y-3">
          ...
          <p className="text-lg text-slate-400">
            Create your account and unlock premium productivity
          </p>
        </div>
